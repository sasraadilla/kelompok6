...
lyr_KUNJUNGAN_2.set('fieldLabels', {'NO': 'no label', 'NAMA TEMPAT': 'no label', 'X': 'no label', 'y': 'no label', });
lyr_Kostkamicsvshp_3.set('fieldLabels', {'id': 'no label', 'Lokasi': 'no label', 'X': 'no label', 'Y': 'no label', 'Luas_w_kos': 'no label', 'JmlahKamar': 'no label', 'J_penghuni': 'no label', 'J_p_mhsITP': 'no label', });
lyr_Kostkamicsv_4.set('fieldLabels', {'id': 'no label', 'Lokasi': 'no label', 'Titik_x': 'no label', 'Titik_y': 'no label', 'Luas_w_kos': 'no label', 'JmlahKamar': 'no label', 'J_penghuni': 'no label', 'J_p_mhsITP': 'no label', });
lyr_Jalur_5.set('fieldLabels', {'id': 'no label', 'Nama_jalur': 'no label', 'Panjang_JL': 'no label', 'Type_JL': 'no label', });
